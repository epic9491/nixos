  ...
  home-manager.users.immich = { ... }: {
    ...
    services.podman = {
      ...
      containers.immich-server = {
        image = "ghcr.io/immich-app/immich-server:v3@sha256:2ab6a6273755d9b8a5c4f25dbaa2d097fc4a2cc261b70bc73621e6405cc106fe";
        autoStart = true;
      ...
      containers.immich-machine-learning = {
        image = "ghcr.io/immich-app/immich-machine-learning:v3@sha256:4f879e40da4910a174ce83c94f717e672dd5f0cb0b8cc2e6b0f47500d788b47e";
        autoStart = true;
        network = "immich.network";
      ...
      containers.immich-redis = {
        image = "docker.io/valkey/valkey:8@sha256:3fbd2e3e4b6e85e046c1e7c215e8f79087bc0357789184305806664e320996f3";
        autoStart = true;
        network = "immich.network";
        networkAlias = [ "redis" ];
        extraConfig = {
