{
  home-manager.users.traefik =
    ...
    in
    {
      ...
      services.podman = {
        ...
        containers.traefik = {
          image = "docker.io/library/traefik:v3.7@sha256:5203c3f39ca70de6790d964624e042463ffbd57715bc82be155cf224c0dd5144";
          autoStart = true;
          ports = [
            "8081:80"
            "8443:443"
  ...
  networking.firewall.extraCommands = ''
    ...
    iptables -t nat -A OUTPUT -d 51.79.74.69 -p tcp --dport 443 -j REDIRECT --to-port 8443
    ip6tables -t nat -A OUTPUT -d 2607:5300:205:200::6e98 -p tcp --dport 443 -j REDIRECT --to-port 8443
  '';
  networking.firewall.extraStopCommands = ''
    ...
    iptables -t nat -D OUTPUT -d 51.79.74.69 -p tcp --dport 443 -j REDIRECT --to-port 8443 || true
    ip6tables -t nat -D OUTPUT -d 2607:5300:205:200::6e98 -p tcp --dport 443 -j REDIRECT --to-port 8443 || true
  '';
