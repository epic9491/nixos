  ...
  home-manager.users.pangolin =
    ...
    in
    {
      ...
      services.podman = {
        ...
        containers.gerbil = {
          image = "docker.io/fosrl/gerbil@sha256:a5e3d7d9008f7d216ac87e77e73090c29b42f5a6f578a7ec2baff28773ae27a7";
          autoStart = true;
        ...
        containers.traefik = {
          image = "docker.io/library/traefik:v3.7@sha256:ef751c695afd26e2be41009047f651153dc1e61ace03e6d13f299d8c4be842b8";
          autoStart = true;
          network = "container:gerbil";
