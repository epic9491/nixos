  ...
  home-manager.users.pangolin =
    ...
    in
    {
      ...
      services.podman = {
        ...
        containers.pangolin = {
          image = "docker.io/fosrl/pangolin:1.22@sha256:4e6f068bbb2b4d0a0a8b7808bcb5b762053208c09d3f074cc58969332d9e3e06";
          autoStart = true;
        ...
        containers.traefik = {
          image = "docker.io/library/traefik:v3.7@sha256:9c2a54d87f76f5c2f5f2682c68394af92fb12c0a2686798d6462a3f84bd78eaf";
          autoStart = true;
          network = "container:gerbil";
        ...
        containers.crowdsec = {
          image = "docker.io/crowdsecurity/crowdsec:v1.8.0@sha256:99eb4df235527e978595ef5ebb30182831686dc875521de67ef39b7659a86897";
          autoStart = true;
          network = "container:gerbil";
          volumes = [
        ...
        containers.crowdsec-export = {
          image = "docker.io/library/python:3.14-alpine@sha256:3f818d6811ff5f3f2b5e5d836df3d25c2dd2e588d3b4981338a8ba17e422f74f";
          autoStart = true;
          network = "container:gerbil";
