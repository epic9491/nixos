locals {
  console_ipv4 = "192.168.0.175"
}
module "deploy_console" {
  source                 = "github.com/nix-community/nixos-anywhere//terraform/all-in-one"
  nixos_system_attr      = "/home/gumbo/nixos#nixosConfigurations.console.config.system.build.toplevel"
  nixos_partitioner_attr = "/home/gumbo/nixos#nixosConfigurations.console.config.system.build.diskoScript"
  target_host            = local.console_ipv4
