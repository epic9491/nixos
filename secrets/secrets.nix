let
  ...
  null = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDK/9uPYOJkAqnA8HVAr+g0aThRP4N8bFd9erpAMMCZY gumbo@null";
  ...
  all-systems = [ secret-mgmt seed k3s-s1 k3s-a1 k3s-a2 k3s-a3 k3s-a4 null ];
